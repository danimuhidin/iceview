...
@section('title', 'Garansi User | Ice View Indonesia')
    ...
    <section class="rounded-2xl border border-slate-700/60 bg-[#0b1222]/85 p-6 sm:p-8">
        <div class="mb-6 flex flex-wrap items-end justify-between gap-4">
            <div>
                ...
                <h1 class="text-2xl font-bold text-white">Manajemen Garansi</h1>
                <p class="mt-1 text-sm text-slate-300">Kelola seluruh transaksi garansi kaca film milik user ini.</p>
            </div>
            <div class="flex items-center gap-2">
                <a href="{{ route('user.warranties.create') }}"
                    class="rounded-md bg-[#00F0FF] px-4 py-2 text-sm font-semibold text-[#0F172A] transition hover:brightness-110">Buat
                    Garansi</a>
            </div>
        </div>
